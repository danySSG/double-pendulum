...
from animation2 import Phase_Space
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.a1_slider = QSlider(self.centralwidget)
        self.a1_slider.setGeometry(QRect(20, 220, 200, 20))
        self.a1_slider.setMinimum(1)
        self.a1_slider.setMaximum(100)
        self.a1_slider.setSingleStep(1)
        self.a1_slider.setProperty("value", 50)
        self.a1_slider.setOrientation(Qt.Horizontal)
        self.a1_slider.setObjectName("a1_slider")

        self.a2_slider = QSlider(self.centralwidget)
        self.a2_slider.setGeometry(QRect(20, 260, 200, 20))
        self.a2_slider.setMinimum(1)
        self.a2_slider.setMaximum(100)
        self.a2_slider.setSingleStep(1)
        self.a2_slider.setProperty("value", 50)
        self.a2_slider.setOrientation(Qt.Horizontal)
        self.a2_slider.setObjectName("a2_slider")
        ...
        self.a1_label.setGeometry(QRect(240, 220, 330, 20))
        self.a1_label.setObjectName("a1_label")

        self.a2_label = QLabel(self.centralwidget)
        self.a2_label.setGeometry(QRect(240, 260, 330, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "НеаОвтономный маятник"))
        ...
        self.a1_label.setText(
            _translate(
                "MainWindow", f"Экспоненциальный коэффициент: {self.a1_slider.value()}"
            )
        )
        self.a2_label.setText(
            _translate(
                "MainWindow", f"Периодичный коэффициент: {self.a2_slider.value()}"
            )
        )
    ...
    def add_functions(self):
        ...
        self.a1_slider.valueChanged.connect(self.change_label_a1)
        self.a2_slider.valueChanged.connect(self.change_label_a2)
    ...
    def make_animation(self):
        ...
        scene = Phase_Space(
            ...
            self.a1_slider.value(),
            self.a2_slider.value(),
        )
    ...
    def change_label_a1(self):
        self.a1_label.setText(f"Экспоненциальный коэффициент: {self.a1_slider.value()}")

    def change_label_a2(self):
        self.a2_label.setText(f"Периодичный коэффициент: {self.a2_slider.value()}")
